...
const Project = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setFileTree(res.data.project.fileTree || {}); // for save...
      });
  ...
  return (
    ...
    `}
              >
                {msg.sender._id === "ai" ? (
                  // If the sender is AI, show avatar + email
                  <div className="flex items-center gap-2 mb-1">
                    <img
                      src="/images/ai_avatar2.jpeg"
                      alt="AI"
                  ...
                  // If the sender is a normal user, show just the email
                ...
                <div className="text-sm">
                  {msg.sender._id === "ai" ? (
                    WriteAiMessage(msg.message) // your AI message rendering
                  ) : (
                    <p>{msg.message}</p>
                  )}
                </div>
